...
Login	4	Valid/invalid credentials, error handling
Registration	4	Including validation on empty required fields
Product page	3	Product details, search-to-detail flow
Search	3	Valid queries, empty results handling
Cart	5	Add/remove items, quantity updates, cart persistence
Checkout	1 (capstone)	Full end-to-end flow from cart to order confirmation, tying the other modules together
...
📊 View test cases & bug reports (Google Sheets)
